...
export default function Home() {
  ...
  useEffect(() => {
    const initApp = async () => {
      ...
      try {
        ...
        if (isMiniApp) {
          // Set up share state provider to control what gets shared
  ...
  // Auto sign-in when in a Farcaster mini app
  useEffect(() => {
    const autoSignIn = async () => {
      if (!isInMiniApp || isLoading || user) return
  ...
  }, [isInMiniApp, isLoading, user, signIn, isInitializing, toast])
          ...
          <>
            <meta
              ...
              content={JSON.stringify({
                version: "next",
                imageUrl: `${window.location.origin}/api/og/home`,
                button: {
                  ...
                  action: {
                    ...
                    splashBackgroundColor: "#1e293b" // slate-800 color
                  }
                }
              })}
            />
